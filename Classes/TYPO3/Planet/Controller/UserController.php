...
class UserController extends AbstractBackendController {
	 ...
	 */
	public function newAction(\TYPO3\Planet\Domain\Model\User $user = NULL) {
	 ...
	 * @Flow\Validate("$userPassword", type="TYPO3\Planet\Domain\Validator\CreateUserPasswordValidator")
	 */
	 ...
	 * @param \TYPO3\Planet\Domain\Model\User $user
	 * @param \TYPO3\Planet\Domain\Dto\UserPassword $userPassword
	 * @Flow\Validate("$userPassword", type="TYPO3\Planet\Domain\Validator\UserPasswordValidator")
	 */
